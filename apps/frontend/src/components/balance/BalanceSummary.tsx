    ...
    return (
        <Card className="honor-card mb-6">
            <div className="flex flex-col items-center p-6">
                ...
                <p className="text-4xl font-bold text-honor-blue mt-2">
                    {currentBalance} билетов
                </p>
            </div>
            ...
            <div className="p-6">
                ...
                <div className="space-y-3">
                    <div className="flex items-start">
                        ...
                        />
                        <p className="text-sm">
                            <span className="font-medium">Регистрация:</span> 10
                            билетов
                        </p>
                    </div>
                    <div className="flex items-start">
                    ...
                    <div className="flex items-start">
                        ...
                        />
                        <p className="text-sm">
                            <span className="font-medium">Активность:</span> 1
                            билет за 5 лайков
                        </p>
                    </div>
                    <div className="flex items-start">
                        ...
                        />
                        <p className="text-sm">
                            <span className="font-medium">Комментарии:</span> 1
                            билет за комментарий
                        </p>
                    </div>
                    <div className="flex items-start">
                        <User
                        ...
                        />
                        <p className="text-sm">
                            <span className="font-medium">Подписки:</span> 3
                            билета за новую подписку
                        </p>
                    </div>
                    <div className="flex items-start">
                        <Clock
