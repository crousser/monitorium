    ...
    return (
        <div className="honor-card relative min-h-[500px] flex items-center justify-center">
            <div className="text-honor-darkGray text-center">
                ...
                <p className="text-sm">
                    (В этом прототипе используется заглушка вместо реальной
                    карты)
                </p>
            </div>
            ...
            {showProblems &&
                ...
                selectedDistrictData.problems.map((problem, index) => (
                    <div
                        key={problem.id}
            ...
            {showStats &&
                districts.map((district, index) => (
                    <div
                        ...
                        <p className="text-sm font-semibold text-honor-blue">
                            {district.name}
                        </p>
                        <div className="flex items-center gap-1 text-xs text-honor-darkGray mt-1">
                            <TrendingUp size={14} />
                            <span>
                                Выполнено: {district.stats.tasksCompleted}/
