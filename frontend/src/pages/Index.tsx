                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg md:text-xl mb-8">
                                ...
                                между избирателями и представителями власти
                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <Link
                            ...
                            <Card className="p-6 h-full cursor-pointer hover:shadow-md transition-shadow">
                                ...
                                <p className="text-honor-darkGray">
                                    Интерактивная карта избирательных округов с
                                    информацией о представителях и активных
                                    заданиях
                                </p>
                            </Card>
                        </Link>
                        ...
                        <Link
                            ...
                            <Card className="p-6 h-full cursor-pointer hover:shadow-md transition-shadow">
                                ...
                                <p className="text-honor-darkGray">
                                    Возможность создавать конкретные задания для
                                    представителей власти и отслеживать их
                                    выполнение
                                </p>
                            </Card>
                        </Link>
                        ...
                        <Link
                            ...
                            <Card className="p-6 h-full cursor-pointer hover:shadow-md transition-shadow">
                                ...
                                <p className="text-honor-darkGray">
                                    Прямое общение между избирателями и
                                    представителями власти через встроенный
                                    мессенджер
                                </p>
                            </Card>
                        </Link>
                        ...
                        <Link
                            ...
                            <Card className="p-6 h-full cursor-pointer hover:shadow-md transition-shadow">
                                ...
                                <h3 className="text-xl font-bold mb-2">
                                    Профили представителей
                                </h3>
                                <p className="text-honor-darkGray">
                                    Подробная информация о представителях
                                    власти, их деятельности и результатах работы
                                </p>
                            </Card>
                        </Link>
                        ...
                        <Link
                            ...
                            <Card className="p-6 h-full cursor-pointer hover:shadow-md transition-shadow">
                                ...
                                <p className="text-honor-darkGray">
                                    Возможность оценивать работу представителей
                                    власти и оставлять отзывы о выполненных
                                    заданиях
                                </p>
                            </Card>
                        </Link>
                        ...
                        <Link
                            ...
                            <Card className="p-6 h-full cursor-pointer hover:shadow-md transition-shadow">
                                ...
                                <p className="text-honor-darkGray">
                                    Рейтинговая система для представителей
                                    власти на основе активности и качества
                                    выполнения заданий
                                </p>
                            </Card>
                        </Link>
            ...
            <div className="py-16">
                <div className="honor-container">
                    ...
                    <p className="text-honor-darkGray text-center max-w-2xl mx-auto mb-12">
                        Простой процесс взаимодействия избирателей и
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <p className="text-honor-darkGray">
                                Зарегистрируйтесь на платформе как избиратель
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-honor-darkGray">
                                Найдите свой избирательный округ на
                                интерактивной карте
                            </p>
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-honor-darkGray">
                                Создавайте задания, общайтесь с представителями
                ...
                <div className="honor-container">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6">
                        ...
                        <Card className="p-4 text-center hover:shadow-md transition-shadow">
                            ...
                            <p className="text-2xl font-bold">
                                {platformStats.completedTasks.toLocaleString(
                                    'ru-RU',
                                )}
                            </p>
                        </Card>
                        ...
                        <Card className="p-4 text-center hover:shadow-md transition-shadow">
                            ...
                            <p className="text-2xl font-bold">
                                {platformStats.activeRepresentatives.toLocaleString(
                                    'ru-RU',
                                )}
                            </p>
                        </Card>
                        ...
                        <Card className="p-6">
                            ...
                            <div className="space-y-4">
                                {[1, 2, 3].map((i) => (
                                    <div
                                        key={i}
                                        className="flex items-start p-3 bg-honor-gray rounded-lg">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <div className="flex items-center mt-1">
                                                <span className="text-xs text-honor-darkGray mr-4">
                                                    12 комментариев
                                                </span>
